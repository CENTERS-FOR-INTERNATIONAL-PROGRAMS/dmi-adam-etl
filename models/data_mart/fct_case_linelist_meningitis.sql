...
hierarchy AS (
    ...
    SELECT 
        ...
        (CASE WHEN c.laboratory_test_requested IS NOT NULL THEN 1 WHEN c.laboratory_tests IS NOT NULL THEN 1 WHEN c.laboratory_tests_other IS NOT NULL THEN 1 ELSE 0 END)::integer AS tested,
        (CASE WHEN c.patient_status IN ('Admitted', 'Discharged', 'Dead') THEN 1 WHEN c.type_of_case = 'Confirmed' THEN 1 ELSE 0 END)::integer AS confirmed,
