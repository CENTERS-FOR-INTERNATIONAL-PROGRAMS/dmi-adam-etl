...
hierarchy AS (
    ...
    SELECT 
        ...
        (CASE WHEN c.culture_done = 'Yes' THEN 1 ELSE 0 END)::integer AS tested,
        (CASE WHEN c.culture_result_diarrhoeal = 'Positive' THEN 1 WHEN c.type_of_case = 'Confirmed' THEN 1 ELSE 0 END)::integer AS confirmed,
