...
hierarchy AS (
    ...
    SELECT 
        ...
        (CASE WHEN c.laboratory_samples_collected IS NOT NULL THEN 1 WHEN c.laboratory_samples_collected_other IS NOT NULL THEN 1 ELSE 0 END)::integer AS tested,
        (CASE WHEN c.result_of_laboratory_test = 'Positive' THEN 1 WHEN c.confirmed_nnt = 'Yes' THEN 1 WHEN c.type_of_case = 'Confirmed' THEN 1 ELSE 0 END)::integer AS confirmed,
