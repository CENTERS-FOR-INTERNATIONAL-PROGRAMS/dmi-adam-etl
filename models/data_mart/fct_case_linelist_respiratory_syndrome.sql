...
hierarchy AS (
    ...
    SELECT 
        ...
        (CASE WHEN c.laboratory_test_conducted IS NOT NULL THEN 1 WHEN c.laboratory_test_conducted_other IS NOT NULL THEN 1 WHEN c.were_laboratory_samples_collected = 'Yes' THEN 1 ELSE 0 END)::integer AS tested,
