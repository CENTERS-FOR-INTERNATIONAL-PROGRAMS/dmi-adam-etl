SELECT
    ...
    COALESCE((doc -> 'DForms' -> 'case_exposure' -> 0 -> 'DFields' -> 'values' -> 'contact_was_symptomatic' ->> 'df_value')::text, (doc -> 'DForms' -> 'case_exposure' -> 0 -> 'DFields' -> 'values' -> 'contact_was_symptomatic' ->> 'df_value')) AS contact_was_symptomatic,
